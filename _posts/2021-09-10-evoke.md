---
title: Announcing Evoke, a GHC plugin for deriving type class instances quickly
---

I'm excited to announce Evoke, a GHC plugin that automatically derives type
class instances without using generics or Template Haskell. What follows is
essentially a copy-paste of the README. You can find the latest documentation
[on GitHub](https://github.com/tfausak/evoke).
